...
class Header {
    ...
    handleKeyBindings(e) {
        ...
        if (e.keyCode !== 8 && e.target.innerText.length > 30) {
            return e.preventDefault();
        }
    }
    render() {
        return (h("header", { class: "teddyt-has-background-secondary" },
            ...
            h("div", { class: "project-name-box" },
                ...
                h("i", { class: "fas fa-edit teddyt-has-text-icon" })),
            h("div", { class: "control-box" },
                h("button", { class: "button is-outlined is-primary", onClick: this.handleNewProject.bind(this) }, "New project"),
                h("button", { class: "button is-danger", onClick: this.handleSaveProject.bind(this) }, "Save"))));
    }
    static get is() { return "teddyt-header"; }
